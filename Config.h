...
#define MIN_DISPENSE_REPEAT_COUNT 0
#define MAX_DISPENSE_REPEAT_COUNT 9999
#define DEFAULT_DISPENSE_REPEAT_COUNT 0

#define MOVE_TEST_REFRESH_INTERVAL_MS 1000
#define DISPENSE_TEST_REFRESH_INTERVAL_MS 1000
